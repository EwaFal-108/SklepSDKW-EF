...
namespace SklepSDKW_EF.DAL
{
    public class FilmsContext : DbContext
    {
        ...
        // Pusty konstruktor dla narzędzi migracyjnych PMC
        public FilmsContext()
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=SklepSDKW_Database;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Category() { Id = 1, Name = "Horror", Desc = "Straszne filmy pełne napięcia, grozy i nadprzyrodzonych zjawisk." },
                new Category() { Id = 2, Name = "Sci-Fi", Desc = "Filmy science fiction osadzone w przyszłości, kosmosie lub alternatywnej rzeczywistości." },
                new Category() { Id = 3, Name = "Komedia", Desc = "Lekkie i humorystyczne produkcje mające na celu rozbawić widza." },
                new Category() { Id = 4, Name = "Dramat", Desc = "Poruszające historie skupiające się na emocjach, relacjach i życiowych dylematach bohaterów." },
                new Category() { Id = 5, Name = "Akcja", Desc = "Dynamiczne filmy z widowiskowymi scenami walki, pościgów i efektów specjalnych." },
                new Category() { Id = 6, Name = "Animacja", Desc = "Filmy tworzone techniką animacji, skierowane zarówno do dzieci, jak i dorosłych." }
            };
            ...
            var films = new List<Film>()
            {
                ...
                new Film() { Id = 7, Title = "The Shining", Director = "Stanley Kubrick", Desc = "Izolacja w hotelu prowadzi do szaleństwa.", CategoryId = 4, Price = 10.99m, Poster = "g7.webp" },
                ...
                new Film() { Id = 26, Title = "The Mask", Director = "Chuck Russell", Desc = "Nieśmiały mężczyzna odkrywa magicczną maskę.", CategoryId = 3, Price = 7.49m, Poster = "g26.jpg" },
                ...
                // DRAMAT (CategoryId = 4) - Poprawiono Id dla Fight Club z 45 na 35
                ...
                // AKCJA (CategoryId = 5)
                new Film() { Id = 41, Title = "Mad Max: Fury Road", Director = "George Miller", Desc = "Pościg przez postapokaliptyczne pustkowia.", CategoryId = 5, Price = 11.99m, Poster = "g41.jpg" },
                new Film() { Id = 42, Title = "John Wick", Director = "Chad Stahelski", Desc = "Były zabójca wraca do świata przestępczego.", CategoryId = 5, Price = 10.99m, Poster = "g42.jpg" },
                new Film() { Id = 43, Title = "Die Hard", Director = "John McTiernan", Desc = "Policjant samotnie walczy z terrorystami.", CategoryId = 5, Price = 9.49m, Poster = "g43.jpg" },
                new Film() { Id = 44, Title = "The Dark Knight", Director = "Christopher Nolan", Desc = "Batman staje do walki z Jokerem.", CategoryId = 5, Price = 12.99m, Poster = "g44.jpg" },
                new Film() { Id = 45, Title = "The Avengers", Director = "Joss Whedon", Desc = "Superbohaterowie łączą siły przeciw zagrożeniu.", CategoryId = 5, Price = 11.49m, Poster = "g45.jpg" },
                new Film() { Id = 46, Title = "Mission: Impossible – Fallout", Director = "Christopher McQuarrie", Desc = "Agent Ethan Hunt wykonuje kolejną niebezpieczną misję.", CategoryId = 5, Price = 12.49m, Poster = "g46.jpg" },
                new Film() { Id = 47, Title = "Casino Royale", Director = "Martin Campbell", Desc = "James Bond rozpoczyna swoją służbę jako agent 007.", CategoryId = 5, Price = 10.99m, Poster = "g47.jpg" },
                new Film() { Id = 48, Title = "Gladiator 2", Director = "Ridley Scott", Desc = "Spektakularne walki na arenie starożytnego Rzymu.", CategoryId = 5, Price = 10.99m, Poster = "g48.jpg" },
                new Film() { Id = 49, Title = "The Bourne Identity", Director = "Doug Liman", Desc = "Mężczyzna bez pamięci odkrywa, że jest wyszkolonym agentem.", CategoryId = 5, Price = 9.99m, Poster = "g49.jpg" },
                new Film() { Id = 50, Title = "300", Director = "Zack Snyder", Desc = "Bitwa Spartan przeciwko perskiej armii.", CategoryId = 5, Price = 10.49m, Poster = "g50.jpg" },

                // ANIMACJA (CategoryId = 6)
                new Film() { Id = 51, Title = "Toy Story", Director = "John Lasseter", Desc = "Zabawki ożywają pod nieobecność właściciela.", CategoryId = 6, Price = 8.99m, Poster = "g51.jpg" },
                new Film() { Id = 52, Title = "The Lion King", Director = "Roger Allers", Desc = "Młody lew walczy o swoje miejsce w królestwie.", CategoryId = 6, Price = 9.99m, Poster = "g52.jpg" },
                new Film() { Id = 53, Title = "Frozen", Director = "Chris Buck", Desc = "Siostrzana miłość w magicznym królestwie.", CategoryId = 6, Price = 9.49m, Poster = "g53.jpg" },
                new Film() { Id = 54, Title = "Shrek", Director = "Andrew Adamson", Desc = "Ogr wyrusza na misję ratowania księżniczki.", CategoryId = 6, Price = 8.49m, Poster = "g54.jpg" },
                new Film() { Id = 55, Title = "Finding Nemo", Director = "Andrew Stanton", Desc = "Ojciec przemierza ocean w poszukiwaniu syna.", CategoryId = 6, Price = 9.29m, Poster = "g55.jpg" },
                new Film() { Id = 56, Title = "Up", Director = "Pete Docter", Desc = "Staruszek wyrusza w podróż domu unoszącego się na balonach.", CategoryId = 6, Price = 9.99m, Poster = "g56.jpg" },
                new Film() { Id = 57, Title = "Coco", Director = "Lee Unkrich", Desc = "Chłopiec odkrywa tajemnice przodków w świecie zmarłych.", CategoryId = 6, Price = 10.49m, Poster = "g57.jpg" },
                new Film() { Id = 58, Title = "Inside Out", Director = "Pete Docter", Desc = "Emocje sterują życiem dziewczynki.", CategoryId = 6, Price = 9.79m, Poster = "g58.jpg" },
                new Film() { Id = 59, Title = "Zootopia", Director = "Byron Howard", Desc = "Policyjna intryga w mieście zamieszkanym przez zwierzęta.", CategoryId = 6, Price = 10.29m, Poster = "g59.jpg" },
                new Film() { Id = 60, Title = "Spirited Away", Director = "Hayao Miyazaki", Desc = "Dziewczynka trafia do magicznego świata duchów.", CategoryId = 6, Price = 11.49m, Poster = "g60.jpg" }
            };
